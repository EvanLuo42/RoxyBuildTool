...
```xml
<ItemGroup>
  <PackageReference Include="RoxyBuildTool" Version="0.1.3" />
  <PackageReference Include="RoxyBuildTool.Platforms.Windows" Version="0.1.3" />
  <PackageReference Include="RoxyBuildTool.Generators.VisualStudio" Version="0.1.3" />
  <PackageReference Include="RoxyBuildTool.Generators.CompilationDatabase" Version="0.1.3" />
</ItemGroup>
```
