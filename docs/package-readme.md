...
RoxyBuildTool is a strongly typed, in-process build description system for C++. Build rules are compiled C# code, and
workspace generators consume the same immutable native configuration and action models.
